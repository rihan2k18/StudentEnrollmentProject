        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages">
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
             ...
             <!--Wrong Email or password message show koranor jonno-->
              ...
              <!--Admin Login Form starts from here...-->
              ...
              <form method="post" action="{{ url('/studentlogin') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input" name="student_email" placeholder="admin name">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input type="password" class="form-control p_input" name="student_password" placeholder="admin password">
                </div>
