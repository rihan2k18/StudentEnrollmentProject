...
@section('content') <!--Layout theke kete aana-->
              ...
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title">Tution Fees</h2>
                   <p style="font-family: cursive;font-size: 20px; font-weight: bold; text-align: center;">Monthly:20,000 taka</p>
                </div>
                <div class="dashboard-chart-card-container">
              ...
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title">Admission</h2>
                   <p style="font-family: cursive;font-size: 30px; font-weight: bold; text-align: center;">Going On</p>
                </div>
                <div class="dashboard-chart-card-container">
