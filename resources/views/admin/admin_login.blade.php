             ...
             <!--Wrong Email or password message show koranor jonno-->
              ...
              <form method="post" action="{{ url('/adminlogin') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input" name="admin_email" placeholder="admin name">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input type="password" class="form-control p_input" name="admin_password" placeholder="admin password">
                </div>
