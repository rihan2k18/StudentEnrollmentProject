                ...
                <div class="card-body overview">
                  ...
                  <div class="info-links">
                    <a class="website">
                      ...
                      <span style="font-family: vernada; font-size: 14px;">{{ $student_profile->student_fathersname }}</span>
                    </a>
                    
                    <a class="website">
                      <i class="icon-globe icon">Mother's Name: </i>
                      <span style="font-family: vernada; font-size: 14px;">{{ $student_profile->student_mothersname }}</span>
                    </a>
                   
                    <a class="website">
                      <i class="icon-globe icon">Student's Adress: </i>
                      <span style="font-family: vernada; font-size: 14px;">{{ $student_profile->student_adress }}</span>
                    </a>

                    <a class="website">
                      <i class="icon-globe icon">Student's Department: </i>
                      <span style="font-family: vernada; font-size: 14px;">{{ convert_department($student_profile->student_department )}}</span>
                    </a>

                    <a class="website">
                      <i class="icon-globe icon">Student's AdmissionYear </i>
                      <span style="font-family: vernada; font-size: 14px;">{{ $student_profile->student_admissionyear }}</span>
                    </a>
